...
/**
 * Test the {@link ListLazyLoad} class.
 *
 * @author Edward Smith
 * @version 0.5
 * @since 0.5
 */
public final class ListLazyLoadTest extends TestCase {

	private ListLazyLoad<String> list;

	public ListLazyLoadTest() {
		super("ListLazyLoad");
	}
	...
	public void testAdd() {
		...
		assertNull(this.list.list);

		this.list.add(foo);
		assertNotNull(this.list.list);
		assertEquals(1, this.list.list.size);
		assertEquals(foo, this.list.get(0));

		this.list.add(foo);
		assertEquals(2, this.list.list.size);
		assertEquals(foo, this.list.get(1));

		this.list.add(foo);
		assertEquals(3, this.list.list.size);
		assertEquals(foo, this.list.get(2));

		this.list.add(foo);
		assertEquals(4, this.list.list.size);
		assertEquals(foo, this.list.get(3));

		this.list.add(foo);
		assertEquals(5, this.list.list.size);
		assertEquals(foo, this.list.get(4));

		this.list.add(foo);
		assertEquals(6, this.list.list.size);
		assertEquals(foo, this.list.get(5));

		this.list.add(foo);
		assertEquals(7, this.list.list.size);
		assertEquals(foo, this.list.get(6));

		this.list.add(foo);
		assertEquals(8, this.list.list.size);
		assertEquals(8, ((Object[]) this.list.list.values).length);
		assertEquals(foo, this.list.get(7));

		this.list.add(foo);
		assertEquals(9, this.list.list.size);
		assertEquals(16, ((Object[]) this.list.list.values).length);
	...
	public void testClear() {
		...
		assertEquals(1, this.list.list.size);
		this.list.clear();
		assertEquals(0, this.list.list.size);
	}
	...
	public void testClone() {
		...
		final ListLazyLoad<String> l = this.list.clone();
	...
	public void testInsert() {
		...
		this.list.insert(0, "foo");
		assertNotNull(this.list.list);
		assertEquals(1, this.list.size());

		this.list.insert(1, "bar");
	...
	public void testInsertAll() {
		...
		this.list.insertAll(0, stringList);
		assertNotNull(this.list.list);
		assertEquals(2, this.list.size());
	...
	public void testSubListFromIndex() {
		...
		final ListArray<String> subList = this.list.subList(1);
	...
	public void testSubListFromIndexToIndex() {
		...
		final ListArray<String> subList = this.list.subList(1, 3);
