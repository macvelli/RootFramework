...
/**
 * Test the {@link ListArrayLongSorted} class.
 *
 * @author Edward Smith
 * @version 0.5
 * @since 0.5
 */
public final class ListArrayLongSortedTest extends TestCase {

	private ListArrayLongSorted list;

	public ListArrayLongSortedTest() {
		super("ListArrayLongSorted");
	}

	@Override
	@Before
	public void setUp() throws Exception {
		this.list = new ListArrayLongSorted();
	}

	@Test
	public void testAdd() {
		final long foo = "foo".hashCode();
		final long bar = "bar".hashCode();
		final long cat = "cat".hashCode();
		final long xyz = "xyz".hashCode();
		final long jet = "jet".hashCode();
		final long dog = "dog".hashCode();
		final long log = "log".hashCode();
	...
	public void testAddAllArray() {
		...
		assertEquals(101574L, this.list.get(1));
		...
		assertEquals(101574L, this.list.get(2));
		assertEquals(101574L, this.list.get(3));
	}
	...
	public void testClone() {
		...
		final ListArrayLongSorted l = this.list.clone();
		assertEquals(2, l.size);
		assertEquals(97299L, l.get(0));
		assertEquals(101574L, l.get(1));
		assertFalse(this.list == l);
	}

	@Test
	public void testConstructorArray() {
		final ListArrayLongSorted l = new ListArrayLongSorted("foo".hashCode(), "bar".hashCode());
		assertEquals(2, l.size);
		assertEquals(97299L, l.get(0));
		assertEquals(101574L, l.get(1));
	}
	...
	public void testConstructorCapacity() {
		ListArrayLongSorted l = new ListArrayLongSorted(15);
		assertEquals(0, l.size);
		assertEquals(15, l.values.length);

		// Test minimum capacity of 8
		l = new ListArrayLongSorted(7);
		assertEquals(0, l.size);
	...
	public void testConstructorCollection() {
		...
		final ListArrayLongSorted l = new ListArrayLongSorted(longList);
		assertEquals(2, l.size);
		assertEquals(8, l.values.length);
		assertEquals(97299L, l.get(0));
		assertEquals(101574L, l.get(1));
	...
	public void testEquals() {
		// Test equals() to a ListArrayLongSorted
		final ListArrayLongSorted testListA = new ListArrayLongSorted();
	...
	public void testExtract() {
		...
		extractor.clear();
		this.list.extract(extractor);
		assertEquals("[97299,101574]", extractor.toString());
	}
	...
	public void testIndexOf() {
		...
		this.list.add("bar".hashCode());
		assertEquals(0, this.list.indexOf("bar".hashCode()));
	}
	...
	public void testRandom() {
		...
		assertEquals(101574L, this.list.random(rng));
	}
	...
	public void testSubListFromIndex() {
		...
		final ListArrayLongSorted subList = this.list.subList(1);
		assertEquals(3, subList.size);
		assertEquals(97299L, subList.get(0));
		assertEquals(101574L, subList.get(1));
		assertEquals(119193L, subList.get(2));
	}
	...
	public void testSubListFromIndexToIndex() {
		...
		final ListArrayLongSorted subList = this.list.subList(1, 3);
	...
	public void testToArray() {
		...
		assertEquals(97299L, array[0]);
		assertEquals(101574L, array[1]);
	}
	...
	public void testToString() {
		...
		this.list.add("bar".hashCode());
		assertEquals("[97299,101574]", this.list.toString());
	}

} // End ListArrayLongSortedTest
