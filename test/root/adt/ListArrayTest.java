...
/**
 * Test the {@link ListArray} class.
 *
 * @author Edward Smith
 * @version 0.5
 * @since 0.5
 */
public final class ListArrayTest extends TestCase {

	private ListArray<String> list;
	...
	public void testClone() {
		...
		final ListArray<String> l = this.list.clone();
	...
	public void testConstructorArray() {
		final ListArray<String> l = new ListArray<>("foo", "bar");
		assertEquals(2, l.size);
	...
	public void testConstructorCapacity() {
		ListArray<String> l = new ListArray<>(15);
		assertEquals(0, l.size);
		assertEquals(15, ((Object[]) l.values).length);

		// Test minimum capacity of 8
		l = new ListArray<>(7);
		assertEquals(0, l.size);
		assertEquals(8, ((Object[]) l.values).length);
	}
	...
	public void testConstructorCollection() {
		...
		final ListArray<String> l = new ListArray<>(stringList);
		assertEquals(2, l.size);
		assertEquals(8, ((Object[]) l.values).length);
		assertEquals("foo", l.get(0));
		assertEquals("bar", l.get(1));
	...
	public void testGetCapacity() {
		...
		assertEquals(((Object[]) this.list.values).length, this.list.getCapacity());
