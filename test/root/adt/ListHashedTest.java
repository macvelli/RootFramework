...
/**
 * Test the {@link ListHashed} class.
 *
 * @author Edward Smith
 * @version 0.5
 * @since 0.5
 */
public final class ListHashedTest extends TestCase {

	private ListHashed<String> list;

	public ListHashedTest() {
		super("ListHashed");
	}
	...
	public void testAdd() {
		...
		assertEquals(0, this.list.set.size);

		this.list.add(foo);
		assertEquals(1, this.list.size());
		assertEquals(1, this.list.set.size);
	...
	public void testAddAllArray() {
		...
		assertEquals(2, this.list.set.size);
	...
	public void testAddAllCollectionWithIndex() {
		...
		assertEquals(4, this.list.size());
		assertEquals(4, this.list.set.size);
	...
	public void testAddWithIndex() {
		...
		this.list.add(1, "xyz");
		assertEquals(3, this.list.size());
		assertEquals(3, this.list.set.size);
	...
	public void testClone() {
		...
		final ListHashed<String> l = this.list.clone();
		assertEquals(2, l.list.size());
		assertEquals(2, l.set.size);
		assertEquals("foo", l.get(0));
		assertEquals("bar", l.get(1));
		assertFalse(this.list == l);
		assertFalse(this.list.list == l.list);
		assertFalse(this.list.set == l.set);
	}

	@Test
	public void testConstructorArray() {
		final ListHashed<String> l = new ListHashed<>("foo", "bar");
		assertEquals(2, l.list.size());
		assertEquals(2, l.set.size);
		assertEquals("foo", l.get(0));
		assertEquals("bar", l.get(1));
	...
	public void testConstructorCapacity() {
		final ListHashed<String> l = new ListHashed<>(15);
		assertEquals(0, l.list.size());
		assertEquals(0, l.set.size);
		assertEquals(15, l.list.getCapacity());
		assertEquals(16, l.set.capacity);
		assertEquals(23, l.set.table.length);
	}
	...
	public void testConstructorCollection() {
		...
		final ListHashed<String> l = new ListHashed<>(stringList);
		assertEquals(2, l.list.size());
		assertEquals(2, l.set.size);
		assertEquals(8, l.list.getCapacity());
		assertEquals(8, l.set.capacity);
		assertEquals(11, l.set.table.length);
		assertEquals("foo", l.get(0));
		assertEquals("bar", l.get(1));
	}
	...
	public void testConstructorDefault() {
		...
		assertEquals(8, this.list.set.capacity);
		assertEquals(11, this.list.set.table.length);
	}
	...
	public void testConstructorRootList() {
		...
		final ListHashed<String> l = new ListHashed<>(rootList);
	...
	public void testSubListFromIndex() {
		...
		final ListHashed<String> subList = this.list.subList(1);
		assertEquals(3, subList.size());
		assertEquals(3, subList.set.size);
	...
	public void testSubListFromIndexToIndex() {
		...
		final ListHashed<String> subList = this.list.subList(1, 3);
		assertEquals(2, subList.list.size());
		assertEquals(2, subList.set.size);
		assertEquals("bar", subList.get(0));
		assertEquals("xyz", subList.get(1));
	}
