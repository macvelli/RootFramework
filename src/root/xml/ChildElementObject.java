 ...
 * @since 0.5
 */
public final class ChildElementObject extends ChildElement {
	...
	public ChildElementObject(final String name, final Object value, final int indent) {
		super(name, indent);
