 ...
 * @since 0.5
 */
public final class ChildElementBoolean extends ChildElement {
	...
	public ChildElementBoolean(final String name, final boolean value, final int indent) {
		super(name, indent);
