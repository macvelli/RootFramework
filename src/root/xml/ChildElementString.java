 ...
 * @since 0.5
 */
public final class ChildElementString extends ChildElement {
	...
	public ChildElementString(final String name, final String value, final int indent) {
		super(name, indent);
