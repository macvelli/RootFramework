 ...
 */
public class CacheTimed<K, V> implements RootCache<K, V> {
	...
	private final class Ascend implements Itemizer<V> {
		...
		public final void reset() {
			this.index = -1;
			this.cursor = CacheTimed.this.listHead;
		}
	...
	public CacheTimed(final int capacity, final long expireDuration) {
